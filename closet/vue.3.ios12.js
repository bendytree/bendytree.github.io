// See:
// and https://babeljs.io/repl#?browsers=ios%20%3E%3D%2012&build=&builtIns=false&corejs=3.21&spec=false&loose=false
...
// See: https://unpkg.com/vue@3/dist/vue.global.js
// and https://babeljs.io/repl#?browsers=ios%20%3E%3D%2012&build=&builtIns=false&corejs=3.21&spec=false&loose=false
...
var Vue = function (exports) {
  ...
  function looseEqual(a, b) {
    ...
    if (aValidType || bValidType) {
      /* istanbul ignore if: this if will probably never be called */if (!aValidType || !bValidType) {
        return false;
      }
      ...
      value: function stop(fromParent) {
        if (this._active) {
          ...
          if (!this.detached && this.parent && !fromParent) {
            ...
            var _last = this.parent.scopes.pop();
            if (_last && _last !== this) {
              this.parent.scopes[this.index] = _last;
              _last.index = this.index;
            }
          }
  ...
  var initDepMarkers = function initDepMarkers(_ref5) {
    var deps = _ref5.deps;
    if (deps.length) {
  ...
  function createIterableMethod(method, isReadonly, isShallow) {
    return function () {
      ...
      var wrap = isShallow ? toShallow : isReadonly ? toReadonly : toReactive;
      !isReadonly && track(rawTarget, "iterate" /* TrackOpTypes.ITERATE */, isKeyOnly ? MAP_KEY_ITERATE_KEY : ITERATE_KEY); // return a wrapped iterator which returns observed versions of the
  ...
  function warn(msg) {
    ...
    if (appWarnHandler) {
      callWithErrorHandling(appWarnHandler, instance, 11 /* ErrorCodes.APP_WARN_HANDLER */, [msg + args.join(''), instance && instance.proxy, trace.map(function (_ref7) {
        var vnode = _ref7.vnode;
        return "at <".concat(formatComponentName(instance, vnode.type), ">");
      }).join('\n'), trace]);
    } else {
      var _console2;
      var warnArgs = ["[Vue warn]: ".concat(msg)].concat(args); /* istanbul ignore if */
      if (trace.length &&
  ...
  function getComponentTrace() {
    ...
    var normalizedStack = [];
    while (currentVNode) {
      var _last2 = normalizedStack[0];
      if (_last2 && _last2.vnode === currentVNode) {
        _last2.recurseCount++;
      } else {
  ...
  function emit$1(event) {
    ...
    if (exports.devtools) {
      var _exports$devtools;
      (_exports$devtools = exports.devtools).emit.apply(_exports$devtools, [event].concat(args));
  ...
  function setDevtoolsHook(hook, target) {
    ...
    if (exports.devtools) {
      ...
      buffer.forEach(function (_ref9) {
        var _exports$devtools2;
        var event = _ref9.event,
          args = _ref9.args;
        return (_exports$devtools2 = exports.devtools).emit.apply(_exports$devtools2, [event].concat(_toConsumableArray(args)));
      });
      buffer = [];
    } else if (
  ...
  var devtoolsComponentRemoved = function devtoolsComponentRemoved(component) {
    if (exports.devtools && typeof exports.devtools.cleanupBuffer === 'function' &&
  ...
  function emit(instance, event) {
    ...
    if (modelArg && modelArg in props) {
      ...
      var _ref10 = props[modifiersKey] || EMPTY_OBJ,
  ...
  function updateHOCHostEl(_ref11, el // HostNode
  ) {
    var vnode = _ref11.vnode,
  ...
  function patchSuspense(n1, n2, container, anchor, parentComponent, isSVG, slotScopeIds, optimized, _ref12) {
    var patch = _ref12.p,
      unmount = _ref12.um,
      createElement = _ref12.o.createElement;
  ...
  function createSuspenseBoundary(vnode, parent, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals) {
    ...
    var suspense = {
      ...
      fallback: function fallback(fallbackVNode) {
        ...
        var anchor = _next2(activeBranch);
      ...
      registerDep: function registerDep(instance, setupRenderEffect) {
        ...
        instance.asyncDep["catch"](function (err) {
          ...
          setupRenderEffect(instance, vnode,
            ...
            hydratedEl ? null : _next2(instance.subTree), suspense, isSVG, optimized);
          if (placeholder) {
            remove(placeholder);
          }
  ...
  function hydrateSuspense(node, vnode, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, rendererInternals, hydrateNode) {
    /* eslint-disable no-restricted-globals */var suspense = vnode.suspense = createSuspenseBoundary(vnode, parentSuspense, parentComponent, node.parentNode, document.createElement('div'), null, isSVG, slotScopeIds, optimized, rendererInternals, true /* hydrating */); // there are two possible scenarios for server-rendered suspense:
    ...
    return result; /* eslint-enable no-restricted-globals */
  }
  ...
  function doWatch(source, cb) {
    var _ref13 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : EMPTY_OBJ,
      immediate = _ref13.immediate,
      deep = _ref13.deep,
      flush = _ref13.flush,
      onTrack = _ref13.onTrack,
      onTrigger = _ref13.onTrigger;
    if (!cb) {
    ...
    var instance = getCurrentScope() === (currentInstance === null || currentInstance === void 0 ? void 0 : currentInstance.scope) ? currentInstance : null; // const instance = currentInstance
    var getter;
  ...
  function getTransitionRawChildren(children) {
    ...
    if (keyedFragmentCount > 1) {
      for (var _i4 = 0; _i4 < ret.length; _i4++) {
        ret[_i4].patchFlag = -2 /* PatchFlags.BAIL */;
      }
    }
    return ret;
  ...
  function createInnerComp(comp, parent) {
    ...
    vnode.ref = ref; // pass the custom element callback on to the inner comp
  ...
  var KeepAliveImpl = {
    ...
    setup: function setup(props, _ref15) {
      ...
      sharedContext.activate = function (vnode, container, anchor, isSVG, optimized) {
        ...
        move(vnode, container, anchor, 0 /* MoveType.ENTER */, parentSuspense); // in case props have changed
  ...
  function renderList(source, renderItem, cache, index) {
    ...
    if (isArray(source) || isString(source)) {
      ...
      for (var _i5 = 0; _i5 < source; _i5++) {
        ret[_i5] = renderItem(_i5 + 1, _i5, undefined, cached && cached[_i5]);
      }
      ...
      if (source[Symbol.iterator]) {
        ...
        for (var _i6 = 0, _l = keys.length; _i6 < _l; _i6++) {
          var key = keys[_i6];
          ret[_i6] = renderItem(source[key], key, _i6, cached && cached[_i6]);
        }
      }
    } else {
      ret = [];
    ...
    var _loop = function _loop() {
      ...
      if (isArray(slot)) {
        ...
        slots[slot.name] = slot.key ? function () {
          var res = slot.fn.apply(slot, arguments); // attach branch key so each conditional branch is considered a
          // different fragment
  ...
  function applyOptions(instance) {
    ...
    if (methods) {
      for (var _key9 in methods) {
        ...
        if (isFunction(methodHandler)) {
          ...
          {
            checkDuplicateProperties("Methods" /* OptionTypes.METHODS */, _key9);
          }
        } else {
          warn("Method \"".concat(_key9, "\" has type \"").concat(_typeof(methodHandler), "\" in the component definition. ") + "Did you reference the function correctly?");
        }
      }
    }
    if (dataOptions) {
      ...
      if (!isObject(data)) {
        ...
        instance.data = reactive(data);
        {
          var _loop2 = function _loop2(_key10) {
            checkDuplicateProperties("Data" /* OptionTypes.DATA */, _key10); // expose data on ctx during dev
    ...
    if (computedOptions) {
      var _loop3 = function _loop3(_key11) {
        ...
        if (get === NOOP) {
          warn("Computed property \"".concat(_key11, "\" has no getter."));
        }
        var set = !isFunction(opt) && isFunction(opt.set) ? opt.set.bind(publicThis) : function () {
          warn("Write operation failed: computed property \"".concat(_key11, "\" is readonly."));
        };
        var c = computed({
          get: get,
          set: set
        ...
        {
          checkDuplicateProperties("Computed" /* OptionTypes.COMPUTED */, _key11);
        }
      };
      ...
      for (var _key13 in rawCurrentProps) {
        if (!rawProps ||
          ...
          if (options) {
            if (rawPrevProps && (
              // for camelCase
              rawPrevProps[_key13] !== undefined ||
              // for kebab-case
              rawPrevProps[kebabKey] !== undefined)) {
              props[_key13] = resolvePropValue(options, rawCurrentProps, _key13, undefined, instance, true /* isAbsent */);
            }
          } else {
            delete props[_key13];
          }
      ...
      for (var key in raw) {
        ...
        if (validatePropName(_normalizedKey)) {
          ...
          if (prop) {
            ...
            prop[1 /* BooleanFlags.shouldCastTrue */] = stringIndex < 0 || booleanIndex < stringIndex; // if the prop needs boolean casting or default value
  ...
  } /* DOMNodeTypes.COMMENT */; // Note: hydration is DOM-specific
  ...
  function baseCreateRenderer(options, createHydrationFns) {
    ...
    var mountElement = function mountElement(vnode, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) {
      ...
      setScopeId(el, vnode, vnode.scopeId, slotScopeIds, parentComponent); // props
      if (props) {
        for (var key in props) {
    ...
    var patchProps = function patchProps(el, vnode, oldProps, newProps, parentComponent, parentSuspense, isSVG) {
      if (oldProps !== newProps) {
        ...
        for (var _key18 in newProps) {
          ...
          var prev = oldProps[_key18]; // defer patching value
  ...
  function toggleRecurse(_ref23, allowed) {
    var effect = _ref23.effect,
  ...
  var TeleportImpl = {
    ...
    remove: function remove(vnode, parentComponent, parentSuspense, optimized, _ref24, doRemove) {
      var unmount = _ref24.um,
        hostRemove = _ref24.o.remove;
      var shapeFlag = vnode.shapeFlag,
        children = vnode.children,
        anchor = vnode.anchor,
  ...
  function moveTeleport(vnode, container, parentAnchor, _ref25) {
    var insert = _ref25.o.insert,
      move = _ref25.m;
    ...
    var el = vnode.el,
      ...
      children = vnode.children,
      props = vnode.props;
    var isReorder = moveType === 2 /* TeleportMoveTypes.REORDER */; // move main view anchor if this is a re-order.
    if (isReorder) {
  ...
  function hydrateTeleport(node, vnode, parentComponent, parentSuspense, slotScopeIds, optimized, _ref26, hydrateChildren) {
    var _ref26$o = _ref26.o,
      nextSibling = _ref26$o.nextSibling,
      parentNode = _ref26$o.parentNode,
      querySelector = _ref26$o.querySelector;
  ...
  function isSameVNodeType(n1, n2) {
    if (n2.shapeFlag & 6 /* ShapeFlags.COMPONENT */ && hmrDirtyComponents.has(n2.type)) {
      ...
      n2.shapeFlag &= ~512 /* ShapeFlags.COMPONENT_KEPT_ALIVE */; // HMR only: if the component has been hot-updated, force a reload.
      return false;
    }
  ...
  function setupStatefulComponent(instance, isSSR) {
    ...
    var Component = instance.type;
    {
      ...
      if (Component.directives) {
        ...
        for (var _i7 = 0; _i7 < _names.length; _i7++) {
          validateDirectiveName(_names[_i7]);
        }
      }
  ...
  function finishComponentSetup(instance, isSSR, skipOptions) {
    ...
    if (!Component.render && instance.render === NOOP && !isSSR) {
      /* istanbul ignore if */if (!compile$1 && Component.template) {
  ...
  function initCustomFormatter() {
    /* eslint-disable no-restricted-globals */if (typeof window === 'undefined') {
      return;
    }
    var vueStyle = {
      style: 'color:#3ba776'
  ...
  function patchStyle(el, prev, next) {
    ...
    if (next && !isCssString) {
      ...
      for (var _key21 in next) {
        setStyle(style, _key21, next[_key21]);
      }
    } else {
  ...
  var VueElement = /*#__PURE__*/function (_BaseClass) {
    ...
    _createClass(VueElement, [{
        ...
        new MutationObserver(function (mutations) {
          ...
          try {
            for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
              var m = _step7.value;
              _this5._setAttr(m.attributeName);
            }
          } catch (err) {
            _iterator7.e(err);
          } finally {
          ...
          if (props && !isArray(props)) {
            for (var key in props) {
              ...
              if (opt === Number || opt && opt.type === Number) {
                if (key in _this5._props) {
                  _this5._props[key] = toNumber(_this5._props[key]);
                }
                (numberProps || (numberProps = Object.create(null)))[camelize(key)] = true;
              }
            }
          }
          _this5._numberProps = numberProps;
          if (isAsync) {
            // defining getter/setters on prototype
            // for sync defs, this already happened in the constructor
            _this5._resolveProps(def);
          } // apply CSS
          _this5._applyStyles(styles); // initial render
          _this5._update();
        };
      ...
      value: function _resolveProps(def) {
        var _this6 = this;
        var props = def.props;
        var declaredPropKeys = isArray(props) ? props : Object.keys(props || {}); // check if there are props set pre-upgrade or connect
        for (var _i8 = 0, _Object$keys = Object.keys(this); _i8 < _Object$keys.length; _i8++) {
          var key = _Object$keys[_i8];
          if (key[0] !== '_' && declaredPropKeys.includes(key)) {
            this._setProp(key, this[key], true, false);
          }
        } // defining getter/setters on prototype
        var _iterator8 = _createForOfIteratorHelper(declaredPropKeys.map(camelize)),
          _step8;
        try {
        ...
        if (!this._instance) {
          vnode.ce = function (instance) {
              ...
              instance.ceReload = function (newStyles) {
                ...
                if (_this7._styles) {
                  _this7._styles.forEach(function (s) {
                    return _this7.shadowRoot.removeChild(s);
                  });
            ...
            var dispatch = function dispatch(event, args) {
              _this7.dispatchEvent(new CustomEvent(event, {
                detail: args
              }));
            }; // intercept emit
      ...
      value: function _applyStyles(styles) {
        ...
        if (styles) {
          styles.forEach(function (css) {
            ...
            s.textContent = css;
            _this8.shadowRoot.appendChild(s); // record for HMR
            {
              (_this8._styles || (_this8._styles = [])).push(s);
            }
          });
        }
      }
  ...
  function useCssVars(getter) {
    var instance = getCurrentInstance(); /* istanbul ignore next */
    if (!instance) {
  ...
  var Transition = function Transition(props, _ref29) {
  ...
  function getTransitionInfo(el, expectedType) {
    ...
    var transitionDelays = getStyleProperties("".concat(TRANSITION$1, "Delay"));
    var transitionDurations = getStyleProperties("".concat(TRANSITION$1, "Duration"));
    ...
    var hasTransform = type === TRANSITION$1 && /\b(transform|all)(,|$)/.test(getStyleProperties("".concat(TRANSITION$1, "Property")).toString());
    return {
      type: type,
      timeout: timeout,
      propCount: propCount,
  ...
  var vModelText = {
    created: function created(el, _ref31, vnode) {
      var _ref31$modifiers = _ref31.modifiers,
        lazy = _ref31$modifiers.lazy,
        trim = _ref31$modifiers.trim,
        number = _ref31$modifiers.number;
    ...
    mounted: function mounted(el, _ref32) {
  ...
  function setChecked(el, _ref34, vnode) {
  ...
  var vModelRadio = {
    created: function created(el, _ref35, vnode) {
    ...
    beforeUpdate: function beforeUpdate(el, _ref36, vnode) {
      var value = _ref36.value,
        oldValue = _ref36.oldValue;
      el._assign = getModelAssigner(vnode);
      if (value !== oldValue) {
        el.checked = looseEqual(value, vnode.props.value);
      }
  ...
  var vModelSelect = {
    ...
    deep: true,
    created: function created(el, _ref37, vnode) {
      var value = _ref37.value,
        number = _ref37.modifiers.number;
    ...
    // <option>s.
    mounted: function mounted(el, _ref38) {
  ...
  var IS_MEMO_SAME = Symbol("isMemoSame"); // Name mapping for runtime helpers that need to be imported from 'vue' in
  ...
  function findDir(node, name) {
    ...
    for (var i = 0; i < node.props.length; i++) {
      var _p = node.props[i];
      if (_p.type === 7 /* NodeTypes.DIRECTIVE */ && (allowEmpty || _p.exp) && (isString(name) ? _p.name === name : name.test(_p.name))) {
        return _p;
      }
    }
  }
  function findProp(node, name) {
    ...
    for (var i = 0; i < node.props.length; i++) {
      ...
      if (_p2.type === 6 /* NodeTypes.ATTRIBUTE */) {
        if (dynamicOnly) continue;
        if (_p2.name === name && (_p2.value || allowEmpty)) {
          return _p2;
        }
      } else if (_p2.name === 'bind' && (_p2.exp || allowEmpty) && isStaticArgOf(_p2.arg, name)) {
        return _p2;
      }
    }
  }
  ...
  function makeBlock(node, _ref47) {
    var helper = _ref47.helper,
      removeHelper = _ref47.removeHelper,
      inSSR = _ref47.inSSR;
    if (!node.isBlock) {
      node.isBlock = true;
  ...
  function checkCompatEnabled(key, context, loc) {
    ...
    if (enabled) {
      for (var _len14 = arguments.length, args = new Array(_len14 > 3 ? _len14 - 3 : 0), _key24 = 3; _key24 < _len14; _key24++) {
        args[_key24 - 3] = arguments[_key24];
      }
  ...
  function warnDeprecation(key, context, loc) {
    ...
    for (var _len15 = arguments.length, args = new Array(_len15 > 3 ? _len15 - 3 : 0), _key25 = 3; _key25 < _len15; _key25++) {
      args[_key25 - 3] = arguments[_key25];
    }
  ...
  function parseChildren(context, mode, ancestors) {
    ...
    if (mode !== 2 /* TextModes.RAWTEXT */ && mode !== 1 /* TextModes.RCDATA */) {
      ...
      for (var _i10 = 0; _i10 < nodes.length; _i10++) {
        var _node2 = nodes[_i10];
        if (_node2.type === 2 /* NodeTypes.TEXT */) {
          if (!context.inPre) {
            if (!/[^\t\r\n\f ]/.test(_node2.content)) {
              var prev = nodes[_i10 - 1];
              var next = nodes[_i10 + 1]; // Remove if:
  ...
  function isComponent(tag, props, context) {
    ...
    for (var i = 0; i < props.length; i++) {
      var _p3 = props[i];
      if (_p3.type === 6 /* NodeTypes.ATTRIBUTE */) {
        if (_p3.name === 'is' && _p3.value) {
          if (_p3.value.content.startsWith('vue:')) {
            return true;
          }
        }
      } else {
        ...
        if (_p3.name === 'is') {
          ...
          _p3.name === 'bind' && isStaticArgOf(_p3.arg, 'is') && false && checkCompatEnabled("COMPILER_IS_ON_ELEMENT" /* CompilerDeprecationTypes.COMPILER_IS_ON_ELEMENT */, context, _p3.loc)) {
          return true;
        }
      }
    }
  ...
  function walk(node, context) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (child.type === 1 /* NodeTypes.ELEMENT */) {
        ...
        for (var _i = 0; _i < child.branches.length; _i++) {
          // Do not hoist v-if single child because it has to be a block
          walk(child.branches[_i], context, child.branches[_i].children.length === 1);
        }
      }
    }
  ...
  function getConstantType(node, context) {
    ...
    switch (node.type) {
      case 1 /* NodeTypes.ELEMENT */:
        ...
        var flag = getPatchFlag(codegenNode);
        if (!flag) {
          var _returnType = 3 /* ConstantTypes.CAN_STRINGIFY */; // Element itself has no patch flag. However we still need to check:
          ...
          if (_returnType > 1 /* ConstantTypes.CAN_SKIP_PATCH */) {
            for (var _i11 = 0; _i11 < node.props.length; _i11++) {
              var _p4 = node.props[_i11];
              if (_p4.type === 7 /* NodeTypes.DIRECTIVE */ && _p4.name === 'bind' && _p4.exp) {
                var expType = getConstantType(_p4.exp, context);
          ...
          if (codegenNode.isBlock) {
            ...
            for (var _i12 = 0; _i12 < node.props.length; _i12++) {
              var _p5 = node.props[_i12];
              if (_p5.type === 7 /* NodeTypes.DIRECTIVE */) {
                constantCache.set(node, 0 /* ConstantTypes.NOT_CONSTANT */);
                return 0 /* ConstantTypes.NOT_CONSTANT */;
              }
            }
  ...
  function createTransformContext(root, _ref48) {
    var _ref48$filename = _ref48.filename,
      filename = _ref48$filename === void 0 ? '' : _ref48$filename,
      _ref48$prefixIdentifi = _ref48.prefixIdentifiers,
      prefixIdentifiers = _ref48$prefixIdentifi === void 0 ? false : _ref48$prefixIdentifi,
      _ref48$hoistStatic = _ref48.hoistStatic,
      hoistStatic = _ref48$hoistStatic === void 0 ? false : _ref48$hoistStatic,
      _ref48$cacheHandlers = _ref48.cacheHandlers,
      cacheHandlers = _ref48$cacheHandlers === void 0 ? false : _ref48$cacheHandlers,
      _ref48$nodeTransforms = _ref48.nodeTransforms,
      nodeTransforms = _ref48$nodeTransforms === void 0 ? [] : _ref48$nodeTransforms,
      _ref48$directiveTrans = _ref48.directiveTransforms,
      directiveTransforms = _ref48$directiveTrans === void 0 ? {} : _ref48$directiveTrans,
      _ref48$transformHoist = _ref48.transformHoist,
      transformHoist = _ref48$transformHoist === void 0 ? null : _ref48$transformHoist,
      _ref48$isBuiltInCompo = _ref48.isBuiltInComponent,
      isBuiltInComponent = _ref48$isBuiltInCompo === void 0 ? NOOP : _ref48$isBuiltInCompo,
      _ref48$isCustomElemen = _ref48.isCustomElement,
      isCustomElement = _ref48$isCustomElemen === void 0 ? NOOP : _ref48$isCustomElemen,
      _ref48$expressionPlug = _ref48.expressionPlugins,
      expressionPlugins = _ref48$expressionPlug === void 0 ? [] : _ref48$expressionPlug,
      _ref48$scopeId = _ref48.scopeId,
      scopeId = _ref48$scopeId === void 0 ? null : _ref48$scopeId,
      _ref48$slotted = _ref48.slotted,
      slotted = _ref48$slotted === void 0 ? true : _ref48$slotted,
      _ref48$ssr = _ref48.ssr,
      ssr = _ref48$ssr === void 0 ? false : _ref48$ssr,
      _ref48$inSSR = _ref48.inSSR,
      inSSR = _ref48$inSSR === void 0 ? false : _ref48$inSSR,
      _ref48$ssrCssVars = _ref48.ssrCssVars,
      ssrCssVars = _ref48$ssrCssVars === void 0 ? "" : _ref48$ssrCssVars,
      _ref48$bindingMetadat = _ref48.bindingMetadata,
      bindingMetadata = _ref48$bindingMetadat === void 0 ? EMPTY_OBJ : _ref48$bindingMetadat,
      _ref48$inline = _ref48.inline,
      inline = _ref48$inline === void 0 ? false : _ref48$inline,
      _ref48$isTS = _ref48.isTS,
      isTS = _ref48$isTS === void 0 ? false : _ref48$isTS,
      _ref48$onError = _ref48.onError,
      onError = _ref48$onError === void 0 ? defaultOnError : _ref48$onError,
      _ref48$onWarn = _ref48.onWarn,
      onWarn = _ref48$onWarn === void 0 ? defaultOnWarn : _ref48$onWarn,
      compatConfig = _ref48.compatConfig;
    ...
    var context = {
      ...
      removeNode: function removeNode(node) {
        ...
        var removalIndex = node ? list.indexOf(node) : context.currentNode ? context.childIndex : -1; /* istanbul ignore if */
        if (removalIndex < 0) {
  ...
  function transform(root, options) {
    ...
    root.helpers = new Set(_toConsumableArray(context.helpers.keys()));
  ...
  function createRootCodegen(root, context) {
    ...
    if (children.length === 1) {
      ...
      var patchFlagText = PatchFlagNames[64 /* PatchFlags.STABLE_FRAGMENT */]; // check if the fragment actually contains a single valid child with
      ...
      root.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, root.children, patchFlag + " /* ".concat(patchFlagText, " */"), undefined, undefined, true, undefined, false /* isComponent */);
    } else ;
  }
  ...
  function traverseNode(node, context) {
    ...
    var exitFns = [];
    for (var _i2 = 0; _i2 < nodeTransforms.length; _i2++) {
      var onExit = nodeTransforms[_i2](node, context);
      if (onExit) {
        if (isArray(onExit)) {
    ...
    switch (node.type) {
      ...
      case 9 /* NodeTypes.IF */:
        for (var _i3 = 0; _i3 < node.branches.length; _i3++) {
          traverseNode(node.branches[_i3], context);
        }
        break;
      case 10 /* NodeTypes.IF_BRANCH */:
      case 11 /* NodeTypes.FOR */:
  ...
  function createCodegenContext(ast, _ref49) {
    var _ref49$mode = _ref49.mode,
      mode = _ref49$mode === void 0 ? 'function' : _ref49$mode,
      _ref49$prefixIdentifi = _ref49.prefixIdentifiers,
      prefixIdentifiers = _ref49$prefixIdentifi === void 0 ? mode === 'module' : _ref49$prefixIdentifi,
      _ref49$sourceMap = _ref49.sourceMap,
      sourceMap = _ref49$sourceMap === void 0 ? false : _ref49$sourceMap,
      _ref49$filename = _ref49.filename,
      filename = _ref49$filename === void 0 ? "template.vue.html" : _ref49$filename,
      _ref49$scopeId = _ref49.scopeId,
      scopeId = _ref49$scopeId === void 0 ? null : _ref49$scopeId,
      _ref49$optimizeImport = _ref49.optimizeImports,
      optimizeImports = _ref49$optimizeImport === void 0 ? false : _ref49$optimizeImport,
      _ref49$runtimeGlobalN = _ref49.runtimeGlobalName,
      runtimeGlobalName = _ref49$runtimeGlobalN === void 0 ? "Vue" : _ref49$runtimeGlobalN,
      _ref49$runtimeModuleN = _ref49.runtimeModuleName,
      runtimeModuleName = _ref49$runtimeModuleN === void 0 ? "vue" : _ref49$runtimeModuleN,
      _ref49$ssrRuntimeModu = _ref49.ssrRuntimeModuleName,
      ssrRuntimeModuleName = _ref49$ssrRuntimeModu === void 0 ? 'vue/server-renderer' : _ref49$ssrRuntimeModu,
      _ref49$ssr = _ref49.ssr,
      ssr = _ref49$ssr === void 0 ? false : _ref49$ssr,
      _ref49$isTS = _ref49.isTS,
      isTS = _ref49$isTS === void 0 ? false : _ref49$isTS,
      _ref49$inSSR = _ref49.inSSR,
      inSSR = _ref49$inSSR === void 0 ? false : _ref49$inSSR;
    var context = {
      mode: mode,
      prefixIdentifiers: prefixIdentifiers,
      sourceMap: sourceMap,
  ...
  function generate(ast) {
    ...
    var isSetupInlined = !true; // preambles
  ...
  function genAssets(assets, type, _ref50) {
    var helper = _ref50.helper,
      push = _ref50.push,
      newline = _ref50.newline,
      isTS = _ref50.isTS;
  ...
  var prohibitedKeywordRE = new RegExp('\\b' + ('arguments,await,break,case,catch,class,const,continue,debugger,default,' + 'delete,do,else,export,extends,finally,for,function,if,import,let,new,' + 'return,super,switch,throw,try,var,void,while,with,yield').split(',').join('\\b|\\b') + '\\b'); // strip strings in expressions
  var stripStringRE = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g; /**
      ...
      var _loop8 = function _loop8() {
        ...
        if (sibling && sibling.type === 9 /* NodeTypes.IF */) {
          ...
          } // check if user is forcing same key on different branches
          {
            ...
            if (key) {
              sibling.branches.forEach(function (_ref51) {
                var userKey = _ref51.userKey;
                if (isSameKey(userKey, key)) {
                  context.onError(createCompilerError(29 /* ErrorCodes.X_V_IF_SAME_KEY */, _branch.userKey.loc));
                }
              });
            }
          }
  ...
  function createChildrenCodegenNode(branch, keyIndex, context) {
    ...
    if (needFragmentWrapper) {
      if (children.length === 1 && firstChild.type === 11 /* NodeTypes.FOR */) {
        ...
        return createVNodeCall(context, helper(FRAGMENT), createObjectExpression([keyProperty]), children, patchFlag + " /* ".concat(patchFlagText, " */"), undefined, undefined, true, false, false /* isComponent */, branch.loc);
      }
    } else {
  ...
  var transformFor = createStructuralDirectiveTransform('for', function (node, dir, context) {
    ...
    return processFor(node, dir, context, function (forNode) {
      ...
      forNode.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, renderExp, fragmentFlag + " /* ".concat(PatchFlagNames[fragmentFlag], " */"), undefined, undefined, true /* isBlock */, !isStableFragment /* disableTracking */, false /* isComponent */, node.loc);
      return function () {
        ...
        if (slotOutlet) {
          ...
          childBlock = createVNodeCall(context, helper(FRAGMENT), keyProperty ? createObjectExpression([keyProperty]) : undefined, node.children, 64 /* PatchFlags.STABLE_FRAGMENT */ + " /* ".concat(PatchFlagNames[64 /* PatchFlags.STABLE_FRAGMENT */], " */"), undefined, undefined, true, undefined, false /* isComponent */);
        } else {
  ...
  function createForLoopParams(_ref52) {
  ...
  function buildSlots(node, context) {
    ...
    var slots = createObjectExpression(slotsProperties.concat(createObjectProperty("_",
      ...
      createSimpleExpression(slotFlag + " /* ".concat(slotFlagsText[slotFlag], " */"), false))), loc);
  ...
  var transformElement = function transformElement(node, context) {
    ...
    return function postTransformElement() {
      ...
      var _node3 = node,
        tag = _node3.tag,
        props = _node3.props;
      var isComponent = node.tagType === 1 /* ElementTypes.COMPONENT */; // The goal of the transform is to create a codegenNode implementing the
      // VNodeCall interface.
  ...
  function buildProps(node, context) {
    ...
    var analyzePatchFlag = function analyzePatchFlag(_ref53) {
      var key = _ref53.key,
        value = _ref53.value;
      if (isStaticExp(key)) {
    ...
    for (var i = 0; i < props.length; i++) {
      ...
      if (prop.type === 6 /* NodeTypes.ATTRIBUTE */) {
        ...
        if (_name === 'is' || isVBind && isStaticArgOf(arg, 'is') && (isComponentTag(tag) || false)) {
          continue;
        ...
        if (directiveTransform) {
          ...
          if (isVOn && arg && !isStaticExp(arg)) {
            pushMergeArg(createObjectExpression(_props2, elementLoc));
          } else {
            var _properties;
    ...
    if (!context.inSSR && propsExpression) {
      switch (propsExpression.type) {
        case 15 /* NodeTypes.JS_OBJECT_EXPRESSION */:
          ...
          for (var _i14 = 0; _i14 < propsExpression.properties.length; _i14++) {
            var key = propsExpression.properties[_i14].key;
            if (isStaticExp(key)) {
  ...
  function processSlotOutlet(node, context) {
    ...
    var nonNameProps = [];
    for (var i = 0; i < node.props.length; i++) {
      var _p6 = node.props[i];
      if (_p6.type === 6 /* NodeTypes.ATTRIBUTE */) {
        if (_p6.value) {
          if (_p6.name === 'name') {
            slotName = JSON.stringify(_p6.value.content);
          } else {
            _p6.name = camelize(_p6.name);
            nonNameProps.push(_p6);
          }
        }
      } else {
        if (_p6.name === 'bind' && isStaticArgOf(_p6.arg, 'name')) {
          if (_p6.exp) slotName = _p6.exp;
        } else {
          if (_p6.name === 'bind' && _p6.arg && isStaticExp(_p6.arg)) {
            _p6.arg.content = camelize(_p6.arg.content);
          }
          nonNameProps.push(_p6);
        }
      }
  ...
  var transformOn$1 = function transformOn$1(dir, node, context, augmentor) {
    var loc = dir.loc,
    ...
    if (node.type === 0 /* NodeTypes.ROOT */ || node.type === 1 /* NodeTypes.ELEMENT */ || node.type === 11 /* NodeTypes.FOR */ || node.type === 10 /* NodeTypes.IF_BRANCH */) {
      ...
      return function () {
        ...
        for (var _i15 = 0; _i15 < children.length; _i15++) {
          var _child2 = children[_i15];
          if (isText$1(_child2) || _child2.type === 8 /* NodeTypes.COMPOUND_EXPRESSION */) {
            var callArgs = []; // createTextVNode defaults to single whitespace, so if it is a
            // single space the code could be an empty call to save bytes.
            if (_child2.type !== 2 /* NodeTypes.TEXT */ || _child2.content !== ' ') {
              callArgs.push(_child2);
            } // mark dynamic text with flag so it gets patched inside a block
            if (!context.ssr && getConstantType(_child2, context) === 0 /* ConstantTypes.NOT_CONSTANT */) {
              callArgs.push(1 /* PatchFlags.TEXT */ + " /* ".concat(PatchFlagNames[1 /* PatchFlags.TEXT */], " */"));
            }
            children[_i15] = {
  ...
  var transformModel$1 = function transformModel$1(dir, node, context) {
    ...
    var expString = exp.type === 4 /* NodeTypes.SIMPLE_EXPRESSION */ ? exp.content : rawExp; // im SFC <script setup> inline mode, the exp may have been transformed into
    // _unref(exp)
    var bindingType = context.bindingMetadata[rawExp]; // check props
  ...
  function getBaseTransformPreset(prefixIdentifiers) {
    return [[transformOnce, transformIf, transformMemo, transformFor].concat([], [transformExpression], [transformSlotOutlet, transformElement, trackSlotScopes, transformText]), {
      on: transformOn$1,
      bind: transformBind,
  ...
  function baseCompile(template) {
    ...
    var isModuleMode = options.mode === 'module'; /* istanbul ignore if */
    {
  ...
  var parserOptions = {
    ...
    getNamespace: function getNamespace(tag, parent) {
      var ns = parent ? parent.ns : 0 /* DOMNamespaces.HTML */;
      if (parent && ns === 2 /* DOMNamespaces.MATH_ML */) {
        if (parent.tag === 'annotation-xml') {
          ...
          if (parent.props.some(function (a) {
            return a.type === 6 /* NodeTypes.ATTRIBUTE */ && a.name === 'encoding' && a.value != null && (a.value.content === 'text/html' || a.value.content === 'application/xhtml+xml');
          })) {
    ...
    getTextMode: function getTextMode(_ref54) {
      var tag = _ref54.tag,
        ns = _ref54.ns;
      if (ns === 0 /* DOMNamespaces.HTML */) {
  ...
  var DOMErrorMessages = (_DOMErrorMessages = {}, _defineProperty(_DOMErrorMessages, 51 /* DOMErrorCodes.X_V_HTML_NO_EXPRESSION */, "v-html is missing expression."), _defineProperty(_DOMErrorMessages, 52 /* DOMErrorCodes.X_V_HTML_WITH_CHILDREN */, "v-html will override element children."), _defineProperty(_DOMErrorMessages, 53 /* DOMErrorCodes.X_V_TEXT_NO_EXPRESSION */, "v-text is missing expression."), _defineProperty(_DOMErrorMessages, 54 /* DOMErrorCodes.X_V_TEXT_WITH_CHILDREN */, "v-text will override element children."), _defineProperty(_DOMErrorMessages, 55 /* DOMErrorCodes.X_V_MODEL_ON_INVALID_ELEMENT */, "v-model can only be used on <input>, <textarea> and <select> elements."), _defineProperty(_DOMErrorMessages, 56 /* DOMErrorCodes.X_V_MODEL_ARG_ON_ELEMENT */, "v-model argument is not supported on plain elements."), _defineProperty(_DOMErrorMessages, 57 /* DOMErrorCodes.X_V_MODEL_ON_FILE_INPUT_ELEMENT */, "v-model cannot be used on file inputs since they are read-only. Use a v-on:change listener instead."), _defineProperty(_DOMErrorMessages, 58 /* DOMErrorCodes.X_V_MODEL_UNNECESSARY_VALUE */, "Unnecessary value binding used alongside v-model. It will interfere with v-model's behavior."), _defineProperty(_DOMErrorMessages, 59 /* DOMErrorCodes.X_V_SHOW_NO_EXPRESSION */, "v-show is missing expression."), _defineProperty(_DOMErrorMessages, 60 /* DOMErrorCodes.X_TRANSITION_INVALID_CHILDREN */, "<Transition> expects exactly one child element or component."), _defineProperty(_DOMErrorMessages, 61 /* DOMErrorCodes.X_IGNORED_SIDE_EFFECT_TAG */, "Tags with side effect (<script> and <style>) are ignored in client component templates."), _DOMErrorMessages);
  ...
  var transformModel = function transformModel(dir, node, context) {
    ...
    baseResult.props = baseResult.props.filter(function (p) {
      return !(p.key.type === 4 /* NodeTypes.SIMPLE_EXPRESSION */ && p.key.content === 'modelValue');
    });
    return baseResult;
  };
  ...
  var transformClick = function transformClick(key, event) {
    ...
    return isStaticClick ? createSimpleExpression(event, true) : key.type !== 4 /* NodeTypes.SIMPLE_EXPRESSION */ ? createCompoundExpression(["(", key, ") === \"onClick\" ? \"".concat(event, "\" : ("), key, ")"]) : key;
  };
    ...
    if (node.type === 1 /* NodeTypes.ELEMENT */ && node.tagType === 1 /* ElementTypes.COMPONENT */) {
      ...
      if (component === TRANSITION) {
        return function () {
          ...
          var child = node.children[0];
          if (child.type === 1 /* NodeTypes.ELEMENT */) {
            var _iterator9 = _createForOfIteratorHelper(child.props),
              _step9;
            try {
              for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
                var _p7 = _step9.value;
                if (_p7.type === 7 /* NodeTypes.DIRECTIVE */ && _p7.name === 'show') {
                  node.props.push({
                    type: 6 /* NodeTypes.ATTRIBUTE */,
                    name: 'persisted',
                    value: undefined,
  ...
  function hasMultipleChildren(node) {
    ...
    var children = node.children = node.children.filter(function (c) {
      return c.type !== 3 /* NodeTypes.COMMENT */ && !(c.type === 2 /* NodeTypes.TEXT */ && !c.content.trim());
    });
    var child = children[0];
  ...
  var DOMNodeTransforms = [transformStyle].concat([transformTransition]);
  ...
  function compileToFunction(template, options) {
    ...
    var _compile2 = compile(template, opts),
      code = _compile2.code;
